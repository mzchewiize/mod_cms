                  ...
                  <div class="parent-wrapper">
                    <div class="parent">
                        ...
                        <div class="child" style="display:inline-block"><img  src="<?php echo base_url();?>webroot/timthumb.php?src=<?php echo base_url();?>webroot/files/<?php echo @$photo['uuid'].'/'.@$photo['image'];?>&w=200&h=200&a=c" />
                          <p style="padding:10px;"> <i class="fa fa-times" onclick="manual_delete_image('<?php echo $photo['item_image_id'];?>','<?php echo $photo['uuid'];?>','<?php echo $photo['image'];?>')" style="cursor:pointer;"> ลบรูป</i></p>
                        </div>
                        <?php } ?>
                      </br/>
                    </div>
  ...
  <script>
    ...
    function seturl_youtube(id,ref_code)
    {
        ...
        $.ajax({
            method: "GET",
            url: '<?php echo base_url();?>index.php/backend/seturl_youtube',
   ...
   function unset_cover(id,ref_code)
    {
        $.ajax({
            method: "GET",
            url: '<?php echo base_url();?>index.php/backend/unset_cover',
            data: { 'id' : id, 'ref_code': ref_code},
        }) 
        .done(function() {
